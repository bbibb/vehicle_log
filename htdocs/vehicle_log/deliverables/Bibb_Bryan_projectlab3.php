...
<!-- Responsive navbar. Eventually this will be its own included file -->
...
<div class="container px-lg-3 py-0 bg-light">
    ...
    <form action="add_vehicle.php" method="post"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="make" placeholder="Enter vehicle model" name="vehicle_model">
        </div>
        <div class="mb-3">
