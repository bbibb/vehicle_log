...
<nav class="navbar navbar-inverse"> <!-- Use this line to set navbar to black with grey font -->
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo $app_URL; ?>/movies_search.php">Search/Edit</a></li>
        <li><a href="<?php echo $app_URL; ?>/movies_about_project.php">About This Project</a></li>
    </ul>

    <ul class="nav navbar-nav navbar-right">
      <!-- <li><a href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li> -->
      <li><a href="<?php echo $app_URL; ?>/admin"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;Admin</a></li>
    </ul>
