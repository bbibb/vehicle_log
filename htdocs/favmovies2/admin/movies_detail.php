...
<!-- Offer to delete the record -->
<form action="<?php echo $app_URL; ?>/movies_delete_confirm.php" method="POST" id="movies_delete_confirm">
<input type="hidden" name="movieID" value="<?php echo $movieID; ?>" />
<button type="submit" class="btn btn-danger">Delete the Movie?</button>
</form>
