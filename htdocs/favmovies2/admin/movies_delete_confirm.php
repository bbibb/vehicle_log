...
<form action="<?php echo $app_URL; ?>/movies_delete.php" method="POST" id="movies_delist">
<input type="hidden" name="movieID" value="<?php echo $movieID; ?>" />
<button type="submit" class="btn btn-danger">Yes, delete this movie</button>
</form>

<div style='float:left'>
<form action="<?php echo $app_URL; ?>/movies_list.php" method="POST" id="movies_list">
<input type="hidden" name="movieID" value="" />
<button type="submit" class="btn btn-success">No, do NOT delete this movie</button>
</form>
</div>
<br />
<br />
